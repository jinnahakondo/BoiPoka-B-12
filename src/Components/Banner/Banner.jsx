...
const Banner = () => {
    return (
        <div className='flex flex-col-reverse gap-20 lg:gap-0 items-center lg:flex-row lg:justify-between lg:items-center mt-12 bg-base-200 rounded-3xl lg:px-28 py-20 '>
            {/* left side */}
