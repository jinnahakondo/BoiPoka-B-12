...
const Book = ({ book }) => {
    ...
    return (
        <Link to={`/book-details/${bookId}`}>
            <div className="card bg-base-100 w-full shadow-md p-6 border border-gray-300 rounded-2xl h-full">
                ...
                <div className='border border-dashed border-gray-300 mb-4 mt-auto'></div>
